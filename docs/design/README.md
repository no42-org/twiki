...
| [gitricorder-ux/](gitricorder-ux/) | The gitricorder web UI contract: `DESIGN.md` (how it looks), `EXPERIENCE.md` (how it behaves), `ARCHITECTURE-SPINE.md` (AD-29 to AD-41, the invariants below the page), HTML mocks. Tracked in #112 |
...
`ARCHITECTURE-SPINE.md` in the same directory continues the `AD-n` series the source code already cites (the code's highest is AD-28); cite those as `AD-29` and so on, unqualified, exactly as the code does.
