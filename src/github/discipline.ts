...
// Re-exported so callers keep one import for the discipline surface; the
// table itself lives in core/ because enrich/ needs it too and AD-5 makes the
// two leaves peers.
export {
  type BackoffDecision,
  backoffDecision,
  MAX_RETRY_AFTER_S,
  SECONDARY_LIMIT_FALLBACK_MS,
